...
export class EvaluationsService {
     ...
     */
    public static listDecisionRevisions<ThrowOnError extends boolean = true>(parameters: {
        finding_id: string;
        limit?: number;
        offset?: number;
    }, options?: Options<never, ThrowOnError>): RequestResult<GetApiV1FindingsByFindingIdDecisionRevisionsResponses, GetApiV1FindingsByFindingIdDecisionRevisionsErrors, ThrowOnError, 'data'> {
        const params = buildClientParams([parameters], [{ args: [
                    { in: 'path', key: 'finding_id' },
                    { in: 'query', key: 'limit' },
                    { in: 'query', key: 'offset' }
                ] }]);
        return (options?.client ?? client).get<GetApiV1FindingsByFindingIdDecisionRevisionsResponses, GetApiV1FindingsByFindingIdDecisionRevisionsErrors, ThrowOnError, 'data'>({
            responseStyle: 'data',
     ...
     */
    public static listEvaluations<ThrowOnError extends boolean = true>(parameters: {
        project_id: string;
        limit?: number;
        offset?: number;
    }, options?: Options<never, ThrowOnError>): RequestResult<GetApiV1ProjectsByProjectIdEvaluationsResponses, GetApiV1ProjectsByProjectIdEvaluationsErrors, ThrowOnError, 'data'> {
        const params = buildClientParams([parameters], [{ args: [
                    { in: 'path', key: 'project_id' },
                    { in: 'query', key: 'limit' },
                    { in: 'query', key: 'offset' }
                ] }]);
        return (options?.client ?? client).get<GetApiV1ProjectsByProjectIdEvaluationsResponses, GetApiV1ProjectsByProjectIdEvaluationsErrors, ThrowOnError, 'data'>({
            responseStyle: 'data',
     ...
     */
    public static createEvaluation<ThrowOnError extends boolean = true>(parameters: {
        project_id: string;
        body?: EvaluationCreate | null;
    }, options?: Options<never, ThrowOnError>): RequestResult<PostApiV1ProjectsByProjectIdEvaluationsResponses, PostApiV1ProjectsByProjectIdEvaluationsErrors, ThrowOnError, 'data'> {
        const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'project_id' }, { key: 'body', map: 'body' }] }]);
...
export class ImportsService {
    ...
    /**
     * Download Sbom Evidence
     *
     * Download the source SBOM, scanner report, assessment, and their checksums.
     */
    public static downloadSbomEvidence<ThrowOnError extends boolean = true>(parameters: {
        run_id: string;
    }, options?: Options<never, ThrowOnError>): RequestResult<GetApiV1RunsByRunIdSbomEvidenceResponses, GetApiV1RunsByRunIdSbomEvidenceErrors, ThrowOnError, 'data'> {
        const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'run_id' }] }]);
        return (options?.client ?? client).get<GetApiV1RunsByRunIdSbomEvidenceResponses, GetApiV1RunsByRunIdSbomEvidenceErrors, ThrowOnError, 'data'>({
            responseStyle: 'data',
     ...
     */
    public static rescanSbom<ThrowOnError extends boolean = true>(parameters: {
        run_id: string;
        body?: SbomRescanCreate | null;
    }, options?: Options<never, ThrowOnError>): RequestResult<PostApiV1RunsByRunIdSbomRescansResponses, PostApiV1RunsByRunIdSbomRescansErrors, ThrowOnError, 'data'> {
        const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'run_id' }, { key: 'body', map: 'body' }] }]);
        return (options?.client ?? client).post<PostApiV1RunsByRunIdSbomRescansResponses, PostApiV1RunsByRunIdSbomRescansErrors, ThrowOnError, 'data'>({
            responseStyle: 'data',
...
export class WaiversService {
     ...
     */
    public static deleteWaiver<ThrowOnError extends boolean = true>(parameters: {
        waiver_id: string;
    }, options?: Options<never, ThrowOnError>): RequestResult<DeleteApiV1WaiversByWaiverIdResponses, DeleteApiV1WaiversByWaiverIdErrors, ThrowOnError, 'data'> {
        const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'waiver_id' }] }]);
        return (options?.client ?? client).delete<DeleteApiV1WaiversByWaiverIdResponses, DeleteApiV1WaiversByWaiverIdErrors, ThrowOnError, 'data'>({
            responseStyle: 'data',
