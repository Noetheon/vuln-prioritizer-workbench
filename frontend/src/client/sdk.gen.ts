...
export class ProjectsService {
    ...
    /**
     * Read Project Risk Insights
     *
     * Read the risk posture aggregate: per-run trend, top driver, mitigation levers.
     */
    public static readProjectRiskInsights<ThrowOnError extends boolean = true>(parameters: {
        project_id: string;
        runs?: number;
        levers?: number;
    }, options?: Options<never, ThrowOnError>) {
        ...
        return (options?.client ?? client).get<GetApiV1ProjectsByProjectIdRiskInsightsResponses, GetApiV1ProjectsByProjectIdRiskInsightsErrors, ThrowOnError, 'data'>({
            responseStyle: 'data',
