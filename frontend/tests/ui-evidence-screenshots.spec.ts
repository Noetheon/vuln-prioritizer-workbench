  ...
  await page.route(`**/api/v1/projects/${mockProject.id}/dashboard`, (route) =>
    fulfillJson(route, {
      ...
      risk_reduction: {
        ...
        residual_steps: [
          { label: "Current", reduction: 0, risk_score: 279.7 },
          { label: "After top 1", reduction: 100, risk_score: 179.7 },
          { label: "After top 3", reduction: 279.7, risk_score: 0 },
          { label: "Remaining", reduction: 279.7, risk_score: 0 },
        ],
        top_opportunities: [
          {
            ...
            finding_count: 1,
            id: "CVE-2024-3094|xz-5-6-0-r0|upgrade",
            in_kev: false,
            label: "CVE-2024-3094 on xz 5.6.0-r0",
            max_cvss: 10,
            max_epss: 0.846,
            owners: ["platform-team"],
            recommended_action:
              "Upgrade affected components with known fixes and validate clean re-import.",
            residual_after: 179.7,
            search_query: "CVE-2024-3094",
          },
          {
            ...
            cve_id: "CVE-2021-44228",
            expected_reduction: 94.2,
            finding_count: 1,
            id: "CVE-2021-44228|log4j-core-2-14-1|upgrade",
            in_kev: true,
            ...
            owners: ["platform-team"],
            recommended_action:
              "Apply vendor updates or remove affected assets from the environment.",
            residual_after: 185.5,
            search_query: "CVE-2021-44228",
          },
        ],
      },
