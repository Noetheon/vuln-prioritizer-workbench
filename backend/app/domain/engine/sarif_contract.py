...
SARIF_FINGERPRINT_KEY = "vuln-prioritizer-workbench/v2"
SARIF_WORKBENCH_FINGERPRINT_KEY = "vuln-prioritizer-workbench/v2"


def sarif_rule_id(cve_id: str) -> str:
    """Return the stable CVE-addressable SARIF rule id."""
    return f"vuln-prioritizer-workbench/{cve_id.lower()}"
