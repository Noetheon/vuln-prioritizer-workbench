...
def build_occurrence_evidence(
    *,
    ...
    return OccurrenceEvidenceV2(
        ...
        package_type=_str_value(raw.get("package_type")),
        ...
        asset_id=_str_value(raw.get("asset_id")),
        asset_owner=_str_value(raw.get("owner")),
        asset_business_service=_str_value(raw.get("business_service")),
        asset_exposure=_str_value(raw.get("asset_exposure")) or _str_value(raw.get("exposure")),
        asset_environment=_str_value(raw.get("asset_environment"))
        or _str_value(raw.get("environment")),
        asset_criticality=_str_value(raw.get("asset_criticality"))
        or _str_value(raw.get("criticality")),
