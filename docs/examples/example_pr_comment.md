...
- NVD diagnostics: `requested=3, cache_hits=3, network_fetches=0, failures=0, content_hits=3, empty_records=0, stale_cache_hits=0`
- EPSS diagnostics: `requested=3, cache_hits=3, network_fetches=0, failures=0, content_hits=3, empty_records=0, stale_cache_hits=0`
- KEV diagnostics: `requested=3, cache_hits=3, network_fetches=0, failures=0, content_hits=2, empty_records=0, stale_cache_hits=0`
