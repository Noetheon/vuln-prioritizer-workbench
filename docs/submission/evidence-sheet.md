...
| The demo flow is Overview -> Projects -> Imports -> Findings -> Finding Detail -> TTP Context -> Assets -> Data Sources -> Risk Acceptance -> Evidence Center -> Settings. | [Demo Readiness](../demo-readiness.md), [Final Demo Flow](https://github.com/Noetheon/vuln-prioritizer-workbench/blob/main/archive/vpw-evidence/final-demo-flow/demo-flow-summary.md) |
